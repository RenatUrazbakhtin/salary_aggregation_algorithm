...
class TestUtils(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.salaries.insert_many(data_to_db)
    ...
    def test_get_aggregated_data(self):
        time_fr = datetime.datetime.strptime("2022-09-01T00:00:00", "%Y-%m-%dT%H:%M:%S")
        time_to = datetime.datetime.strptime("2022-12-31T23:59:00", "%Y-%m-%dT%H:%M:%S")
        group = "month"
